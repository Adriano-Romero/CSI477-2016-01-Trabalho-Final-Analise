...
### 6.8 Caso de Uso VIII – Tabela de todos os tipo de produtos existentes
  ...
  - **Garantias de sucesso:** Nova aba é aberta e uma tabela é exibida. Em seguida, o usuário pode visualizar os produtos e fazer a compra dos mesmos se desejado.
  - **Cenário de sucesso principal:**
